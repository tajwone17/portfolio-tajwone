...
export default function ProjectCard({project}) {
  ...
  return (
    <div className="group relative rounded-2xl bg-white/5 border border-white/10 overflow-hidden hover:border-primary/30 transition-all duration-300">
      ...
      <div className="p-6 space-y-4">
        <div>
          ...
          <p className="text-white/60 text-sm leading-relative line-clamp-2">
            {description}
          </p>
        </div>
