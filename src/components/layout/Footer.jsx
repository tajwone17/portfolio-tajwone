    ...
    <footer className="relative bg-black overflow-hidden border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <FadeIn delay={0}>
            <div>
              <h3 className="text-3xl font-bold bg-linear-to-br from-primary/80 via-primary to-primary/80 bg-clip-text text-transparent mb-4">
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 ">
              ...
              <p className="flex items-center gap-2 text-white/50 text-sm">
                Built with{" "}
                <Heart className="fill-primary animate-pulse w-4 h-4 text-primary" />{" "}
